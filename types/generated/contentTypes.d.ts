...
export interface ApiCategoriaProductoCategoriaProducto
  ...
  info: {
    description: 'Categor\u00EDas para clasificar productos';
...
export interface ApiClienteCliente extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Clientes del sistema de \u00F3ptica';
    displayName: 'Cliente';
    pluralName: 'clientes';
  ...
  attributes: {
    ...
    numero_identificacion: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    telefono: Schema.Attribute.String;
    tipo_identificacion: Schema.Attribute.Enumeration<
      ['CC', 'CE', 'NIT', 'Pasaporte']
    > &
      Schema.Attribute.Required &
...
export interface ApiDetalleFacturaDetalleFactura
  ...
  info: {
    description: 'L\u00EDneas de detalle de facturas';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    porcentaje_iva: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valor_iva: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    valor_total_linea: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiFacturaFactura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    medio_pago: Schema.Attribute.Enumeration<
      [
        'Efectivo',
        'Tarjeta D\u00E9bito',
        'Tarjeta Cr\u00E9dito',
...
export interface ApiMovimientoInventarioMovimientoInventario
  extends Struct.CollectionTypeSchema {
  collectionName: 'movimiento_inventarios';
  info: {
    description: 'Movimientos de entrada/salida de inventario';
    displayName: 'Movimiento Inventario';
    pluralName: 'movimiento-inventarios';
    singularName: 'movimiento-inventario';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    producto: Schema.Attribute.Relation<'manyToOne', 'api::producto.producto'>;
    publishedAt: Schema.Attribute.DateTime;
    stock_resultante: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    tipo_movimiento: Schema.Attribute.Enumeration<
      ['Entrada', 'Salida', 'Ajuste Inventario', 'Devoluci\u00F3n']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Text;
    detalles_factura: Schema.Attribute.Relation<
      'oneToMany',
      'api::detalle-factura.detalle-factura'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    movimientos_inventario: Schema.Attribute.Relation<
      'oneToMany',
      'api::movimiento-inventario.movimiento-inventario'
    >;
    ...
    referencia: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    stock_actual: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiUsuarioUsuario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    password_hash: Schema.Attribute.Password &
      ...
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    roles: Schema.Attribute.Relation<'manyToMany', 'api::rol.rol'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::movimiento-inventario.movimiento-inventario': ApiMovimientoInventarioMovimientoInventario;
